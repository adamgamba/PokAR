  ...
  function createBlock(positionArray, colorArray) {
    ...
    switch (script.numStacksPlaced) {
      ...
      case 2:
        ...
        print("DIST BETWEEN A AND POT = " + dist);
        print("DIST BETWEEN B AND POT = " + dist);
        if (distA < 5 || distB < 5) {
          return;
        }
        ...
        break;
      default:
        print("ERROR - script = " + script.numStacksPlaced);
        print("ERROR - typeof = " + typeof script.numStacksPlaced);
        print("done placing: locations = " + script.stackPositions);
        return;
    }
