...
MathUtils.mapValue = function (
  ...
  if (Math.abs(_inputMin - _inputMax) < 0.0000001) {
    ...
    var outVal =
      ((_value - _inputMin) / (_inputMax - _inputMin)) *
...
// ----------------------------------------------------------------------------
MathUtils.linearStepInOut = function (
  _low0,
  _high0,
  _high1,
  _low1,
  ...
  return (
    MathUtils.linearStep(_low0, _high0, _t) *
    (1.0 - MathUtils.linearStep(_high1, _low1, _t))
  );
};
...
// ----------------------------------------------------------------------------
MathUtils.smoothStepInOut = function (
  _low0,
  _high0,
  _high1,
  _low1,
  ...
  return (
    MathUtils.smoothStep(_low0, _high0, _t) *
    (1.0 - MathUtils.smoothStep(_high1, _low1, _t))
  );
};
